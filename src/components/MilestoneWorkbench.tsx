...
export const MilestoneWorkbench: React.FC = () => {
  ...
  return <div className="space-y-4">
    ...
    <div className={card}>
      <div className="flex items-center justify-between mb-3"><div><h3 className="text-sm font-bold text-slate-100">Qwen Coder & VRAM Tuner</h3><p className="text-[10px] text-slate-500">Phase 16 · Controlled layer sweep with thermal/VRAM safety checks.</p></div><Gauge className="w-4 h-4 text-amber-400" /></div>
