...
export const MilestoneChecklist: React.FC<MilestoneChecklistProps> = ({ activeRestorePoint }) => {
  const [phases] = useState<LifecyclePhase[]>([
    ...
    { phase: 60, name: 'Wan 2.1 VACE 1.3B FP16 Model Mounting & Whippet Anchor Smoke Test', status: 'COMPLETED', details: 'VACE safetensors indexed in server prewarm/registry, Video/Gif Studio dropdown integration, Whippet character slot anchor controls, and 12-frame micro-baseline preset.' }
  ]);
  ...
  const [restorePoints] = useState<RestorePoint[]>([
    ...
    { id: 'RESTORE_V1.20.13_WAN_VACE_MODEL_MOUNT_AND_WHIPPET_ANCHOR', label: 'Wan 2.1 VACE Model Mount & Whippet Anchor Smoke Test', description: 'Authoritative Phase 60 restore point: wan2.1_vace_1.3B_fp16.safetensors mounted and indexed across capability manager, server prewarm, VideoStudio VACE/Whippet anchor controls, and 12-frame baseline preset.', timestamp: '2026-09-25 15:40', status: 'ACTIVE' },
  ]);
