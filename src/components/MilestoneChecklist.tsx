...
export const MilestoneChecklist: React.FC<MilestoneChecklistProps> = ({ activeRestorePoint }) => {
  ...
  const [restorePoints] = useState<RestorePoint[]>([
    ...
    { id: 'RESTORE_V1.20.7_BROADER_CODE_REVIEW_HARDENING', label: 'Broader Code Review & Autonomy Hardening', description: 'Authoritative Phase 55 restore point: autonomous repair now performs constrained edits, cancellation is job-scoped, duplicate image input is removed, and active retired-engine vocabulary is reconciled.', timestamp: '2026-09-13 17:20', status: 'ACTIVE' },
  ]);
