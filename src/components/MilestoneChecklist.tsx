...
export const MilestoneChecklist: React.FC<MilestoneChecklistProps> = ({ activeRestorePoint }) => {
  const [phases] = useState<LifecyclePhase[]>([
    ...
    { phase: 58, name: 'Voice Engine Repair & Fluid Layout', status: 'IN_PROGRESS', details: 'Deterministic Python binding, SQLite write-path diagnostics, physical audio manipulation and full-width 12-column layout.' }
  ]);
