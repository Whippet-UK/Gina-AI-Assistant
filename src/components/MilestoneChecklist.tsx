...
export const MilestoneChecklist: React.FC<MilestoneChecklistProps> = ({ activeRestorePoint }) => {
  ...
  const [restorePoints] = useState<RestorePoint[]>([
    ...
    { id: 'RESTORE_V1.20.7_STREAMINJECT_INPAINT_WATERMARK_ERASER', label: 'StreamInject CPU Watermark Eraser Matrix', description: 'Authoritative Phase 55 restore point: CPU-only OpenCV Telea inpainting pre-pass with percentage-controlled bounding coordinates and synchronized dashboard/API/Python controls.', timestamp: '2026-09-13 18:30', status: 'ACTIVE' },
  ]);
