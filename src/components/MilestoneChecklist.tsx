...
export const MilestoneChecklist: React.FC<MilestoneChecklistProps> = ({ activeRestorePoint }) => {
  ...
  const [restorePoints] = useState<RestorePoint[]>([
    ...
    { id: 'RESTORE_V1.20.5_FLUX_HIGH_PRECISION_T5_RECONCILIATION', label: 'FLUX.1 Lite High-Precision T5 Text Encoder Reconciliation', description: 'Reconciled DualCLIPLoader clip_name2 to genuine T5-XXL FP8 (vocab size 32,128) resolving T5 state_dict shared.weight size mismatch, added automatic workflow adaptation and startup workflow self-healing.', timestamp: '2026-09-13 01:00', status: 'ACTIVE' },
  ]);
