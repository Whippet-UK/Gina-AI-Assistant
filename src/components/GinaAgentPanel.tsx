      ...
      <div className="grid lg:grid-cols-[1.2fr_0.9fr] gap-4">
        <div>
          ...
          <div className="flex flex-wrap gap-2 mt-3">
            ...
            <button onClick={() => void quickAction('verify_definition_of_done')} className="px-3 py-2 rounded border border-emerald-500/40 bg-emerald-500/10 text-emerald-300 text-[9px] font-bold uppercase tracking-wider flex items-center gap-2"><CheckCircle2 className="w-3.5 h-3.5" /> Definition of Done</button>
            <button onClick={() => void quickAction('inspect_project_map')} className="px-3 py-2 rounded border border-cyan-500/40 bg-cyan-500/10 text-cyan-300 text-[9px] font-bold uppercase tracking-wider flex items-center gap-2"><FolderOpen className="w-3.5 h-3.5" /> Project Map</button>
