...
- Vision Models: Qwen2.5-VL-7B-Instruct-Q4_K_M.gguf + mmproj-F16.gguf (3584 hidden size) and Qwen3.5-9B-Q4_K_M.gguf + mmproj-BF16.gguf (4096 hidden size, model-matched). Optional Coder Model: qwen2.5-coder-7b-instruct-q5_k_m.gguf.
