...
const defs: RawTool[] = [
  ...
  ['scaffold_web_app','Scaffold React web app','Create a deterministic Vite + React + TypeScript web-app foundation at a safe local path; follow with edits, install and validation.','web-app','write','explicit',{path:{type:'string',required:true,description:'Target directory inside Gina root'},appName:{type:'string',description:'Application name'}},['code-task']],
