...
function seedSystemPresets(instance: DatabaseSync) {
  const presets: VoiceRecord[] = [
    ...
    { voice_id:'xtts_ana_florence', speaker_name:'Ana Florence', gender:'Female', age_group:'Young Adult', primary_language:'en', accent_dialect:'US', tone_tags:['Warm','Narration','Calming'], engine_compatibility:['xtts'], xtts_embedding_path:null, bark_prompt_path:null, preview_audio_url:null, category:'system', favorite:false },
    { voice_id:'xtts_daisy', speaker_name:'Daisy', gender:'Female', age_group:'Young Adult', primary_language:'en', accent_dialect:'UK', tone_tags:['Energetic','Clear'], engine_compatibility:['xtts'], xtts_embedding_path:null, bark_prompt_path:null, preview_audio_url:null, category:'system', favorite:false },
    { voice_id:'xtts_english_male', speaker_name:'English Male', gender:'Male', age_group:'Middle Aged', primary_language:'en', accent_dialect:'UK', tone_tags:['Deep','Corporate','Steady'], engine_compatibility:['xtts'], xtts_embedding_path:null, bark_prompt_path:null, preview_audio_url:null, category:'system', favorite:false },
  ];
